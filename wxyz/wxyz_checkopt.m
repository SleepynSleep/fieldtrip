function opt = wxyz_checkopt(opt, key, allowedtype, allowedval)
% WXYZ_CHECKOPT
% Modified from the FT_CHECKOPT function of the Fieldtrip toolbox.
% 
% WXYZ_CHECKOPT does a validity test on the types and values of a configuration
% structure or cell-array with key-value pairs.
%
% Use as
%   opt = wxyz_checkopt(opt, key)
%   opt = wxyz_checkopt(opt, key, allowedtype)
%   opt = wxyz_checkopt(opt, key, allowedtype, allowedval)
%
...
% function pass.
%
% See also WXYZ_GETOPT, WXYZ_SETOPT
%
